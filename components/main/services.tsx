...
const services = [
  ...
  },
  {
    ...
    description: "Scalable server-side solutions, APIs, and database design for your applications",
            ...
            >
              <CardContainer className="w-full h-full">
                <CardBody>
                  ...
                  <CardItem translateZ={80} className="flex items-center justify-end">
                    <motion.a
                      href="#contact"
