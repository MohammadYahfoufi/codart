...
interface DoubleFBO extends FBO {
  read: FBO;
  write: FBO;
  swap: () => void;
}
...
function SplashCursor({
  ...
  CURL = 3,
  SPLAT_RADIUS = 0.1, // Reduced from 0.2 for less effect radius
  SPLAT_FORCE = 4000, // Reduced from 6000 for gentler effect
  SHADING = true,
  ...
  useEffect(() => {
    ...
    const blit = (() => {
      ...
      if (!arrayBuffer || !elementBuffer) throw new Error('Failed to create WebGL buffers');
